...
export const AboutSection = () => {
  ...
  return (
   <div className="py-20 lg:py-28">
    ...
    <SectionHeader  eyebrow="About Me" title="A Glimpse of My Journey" description="Discover my background, expertise, and passion for software development." />
    <div className="mt-20 flex flex-col gap-8">
      ...
      <Card className="h-[320px] md:col-span-2 lg:col-span-1">
       ...
       <Card className="h-[320px] md:col-span-3 lg:col-span-2">
          <CardHeader title="My Toolbox" description="Explore the technologies and tools I use to bring ideas to life." className="" />
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
        <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2">
            <CardHeader title="Beyond the Code" description="Explore my interests and hobbies beyond coding." className="px-6 py-6" />
