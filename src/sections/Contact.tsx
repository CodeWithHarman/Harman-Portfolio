        ...
        <div className="absolute inset-0 opacity-5 -z-10"
         ...
         <div className="flex flex-col md:flex-row gap-8 md:gap-20 items-center">
          <div>
            ...
            <p className="text-sm md:text-base mt-2">{"I'm always open to new opportunities and collaborations."}</p>
        </div>
        <div>
          <a target="_blank" href="https://www.linkedin.com/in/harman-b-710241203/">
